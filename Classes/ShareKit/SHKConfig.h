...
#define SHKFacebookKey				@"8d92e65368229bae77fe3893f5e846ad"
#define SHKFacebookSecret			@"495621f5eb49e4f21647af400f0b7e42"
#define SHKFacebookSessionProxyURL  @""

// Read It Later - http://readitlaterlist.com/api/?shk
#define SHKReadItLaterKey			@"257d6J01T28f3C34b9Aa36aa30gdFnu9 "
 ...
 */
#define SHKTwitterConsumerKey		@"60hIXALWAnxKfc61bC2oFg"
#define SHKTwitterSecret			@"o5vAsHpMlWDdiYUlaItlNcRDKIgZJ7rraAp02ofeBgY"
#define SHKTwitterCallbackUrl		@"http://offover.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"bluekite2000" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"bluekite2000"
#define SHKBitLyKey					@"R_f2b853a57300a3f875a1cc1307b08aad"
